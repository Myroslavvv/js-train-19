...
Object.defineProperty(ScienceBook, "info", {configurable: false,
    ...
    get() {
        return(`Про книгу ${this.title}: ${this.item}`);
    }
});

try {
    ScienceBook.info = 555;
} catch (err) {
...
Textbook = {
    ...
    author: "Дж. Д. Джонс",
    read() {
        console.log(`Ви читаєте підручник ${this.title} від ${this.author}. ${ScienceBook.info}`)
    }
}
Textbook.read();
